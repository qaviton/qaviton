...
class presence_of_element_located(object):
    ...
    def __call__(self, driver):
        return base_functions.find_element(self.locator, driver, self.index)
...
class visibility_of_element_located(object):
    ...
    def __call__(self, driver):
        try:
            return _element_if_visible(base_functions.find_element(self.locator, driver, self.index))
...
class presence_of_all_elements_located(object):
    ...
    def __call__(self, driver):
        return base_functions.find_elements(self.locator, driver)
...
class visibility_of_any_elements_located(object):
    ...
    def __call__(self, driver):
        """:rtype: list[WebElement]"""
        return [element for element in base_functions.find_elements(self.locator, driver) if _element_if_visible(element)]
...
class visibility_of_all_elements_located(object):
    ...
    def __call__(self, driver):
        """:rtype: list[WebElement]"""
        try:
            elements = base_functions.find_elements(self.locator, driver)
...
class text_to_be_present_in_element(object):
    ...
    def __call__(self, driver):
        try:
            element_text = base_functions.find_element(self.locator, driver, self.index).text
...
class text_to_be_present_in_element_value(object):
    ...
    def __call__(self, driver):
        try:
            element_text = base_functions.find_element(self.locator, driver, self.index).get_attribute("value")
            if element_text:
                return self.text in element_text
            else:
                return False
...
class invisibility_of_element_located(object):
    ...
    def __call__(self, driver):
        try:
            return _element_if_visible(base_functions.find_element(self.locator, driver, self.index), False)
...
class element_located_to_be_selected(object):
    ...
    def __call__(self, driver):
        """:rtype: WebElement"""
        return base_functions.find_element(self.locator, driver, self.index).is_selected()
...
class element_located_selection_state_to_be(object):
    ...
    def __call__(self, driver):
        try:
            element = base_functions.find_element(self.locator, driver, self.index)
